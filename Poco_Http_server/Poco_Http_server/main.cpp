...
//        response.setContentType(Poco::Net::MediaType );
//        response.setDate(<#const Poco::Timestamp &dateTime#>);
//        response.setKeepAlive(<#bool keepAlive#>);
//        response.setTransferEncoding(<#const std::string &transferEncoding#>);
